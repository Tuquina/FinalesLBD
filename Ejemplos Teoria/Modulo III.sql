...
-- Consultas básicas - Orden de datos en MySQL
...
-- Consultas básicas - Eliminación de duplicados en MySQL
...
-- Consultas básicas - Cambio de nombres a las columnas en MySQL

SELECT idProducto AS 'Producto #', nombre 'Nombre', descripcion 'Descripción'
FROM Productos;


-- Consultas básicas - Uso de constantes en MySQL

SELECT idProducto AS 'Producto #', 'ID:', nombre 'Nombre', descripcion 'Descripción'
FROM Productos;


-- Consultas básicas - CASE simple en MySQL
...
-- Consultas básicas - CASE búsqueda en MySQL
...
-- Consultas básicas - COALESCE en MySQL
...
-- Consultas básicas - IFNULL en MySQL
...
-- Consultas básicas - NULLIF en MySQL
-- Devuelve NULL sin las 2 expresiones son iguales
...
-- Consultas básicas - Modificación de filas en MySQL
...
-- Consultas básicas - Borrado de filas en MySQL
...
FROM Productos JOIN Marcas
ON Productos.idMarca = Marcas.idMarca;
-- No muestra las marcas que no tienen un producto
...
SET atributos = '[{"Atributo": "Pantalla", "Valor": "50 pulgadas", "idAtributo": "1", "idAtributoPadre": null}, 
                  ...
                  {"Atributo": "Izquierdo", "Valor": "10 watt", "idAtributo": 7, "idAtributoPadre": 4},
                  {"Atributo": "Derecho", "Valor": "10 watt", "idAtributo": 8, "idAtributoPadre": 4},
                  {"Atributo": "Red", "Valor": ["GSM" , "CDMA" , "HSPA" , "EVDO"], "idAtributo": 9, "idAtributoPadre": null}
				 ]'
WHERE idProducto = 1;
